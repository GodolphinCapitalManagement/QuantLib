...
#include <ql/experimental/amortizingpools/amortizingfixedratepool.hpp>
...
namespace QuantLib {
    ...
    AmortizingFixedRatePool::AmortizingFixedRatePool(
    ...
    : Bond(settlementDays, schedule.calendar(), issueDate),
      ...
      dayCounter_(accrualDayCounter) {
        ...
        QL_ENSURE(!cashflows().empty(), "pool with no cashflows!");
    }
    ...
    namespace  {
        ...
        std::vector<Real> sinkingNotionals(const Period& maturityTenor,
            ...
            QL_REQUIRE(isSubPeriod(freqPeriod, maturityTenor, nPeriods),
                       "Pool frequency is incompatible with the maturity tenor");
